        ...
        <div className={`${(nowPage === 1) ? "" : "hidden"} overflow-scroll-y`}>
            ...
            <div className={"mb-4"}>
                <div className={"bg-red-200 p-2 mb-2"}>
                    <div>[창1:26 ~ 27]</div>
                    <div>26 하나님이 이르시되 우리의 형상을 따라 우리의 모양대로 우리가 사람을 만들고 그들로 바다의 물고기와 하늘의 새와 가축과 온 땅과 땅에 기는 모든 것을 다스리게 하자 하시고
                    </div>
            ...
            <div className={"mb-4"}>
                <div className={"bg-red-200 p-2 mb-2"}>
                    ...
                    <div>26 여호와는 그 얼굴을 네게로 향하여 드사 평강 주시기를 원하노라 할지니라 하라</div>
                </div>
                <div className={`mb-2`}>
