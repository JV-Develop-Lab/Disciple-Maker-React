        ...
        <div className={`${(nowPage === 1) ? "" : "hidden"} overflow-scroll-y`}>
            <div className={"mb-6"}>
                <div className={`text-red-500`}>
                    인간은 행복하기를 원합니다.
                    행복은 어디에서 찾을 수 있을까요? 돈과 명예,많은 지식은 사람들에게 잠깐의 행복을 줄 수 있지만
                    영원한 행복을 줄 수는 없습니다. 사람은 인생의 가치를 발견하면서 살 때 가장 큰 행복을 느낍니다. 가치 있는 삶을 살기 위해서는 가장 먼저 내가 누구인지 알 때 그 목적대로 살 수 있습니다.
                </div>
            </div>
            ...
            <div className={"mb-4"}>
                ...
                <div>
                    ...
                    왜냐하면 사람은 하나님의 형상을 따라 창조되었기 때문입니다. 하나님의 형상을 따라 지음 받은 사람이기에 하나님의 성품과 능력, 사랑, 의지를 가지고 있습니다.
                    그러므로 나는 세상에서 가장 가치 있고 존귀한 사람입니다. 세상에서 가장 아름다운 최고의 작품은 바로 '나'입니다.
                </div>
            </div>
            <div className={"mb-2 font-semibold"}>
            ...
            <div className={"mb-4"}>
                <div className={"bg-red-200 p-2 mb-2"}>
                    ...
                    <div>26 여호와는 그 얼굴을 네게로 향하여 드사 평강 주시기를 원하노라</div>
                </div>
                <div className={`mb-2`}>
                    나는 사랑받기 위해 태어난 사람입니다. 하나님은 끊임없이 복을 주길 원하시며, 나를 지켜주기를 원하십니다. 어떤 어려움이 와도 내가 평안하기를 원하시며 나를 돕기를 원하시는 분이 바로 하나님이십니다.
                    혹시 이해할 수 없는 문제로 어려움을 겪고 계십니까?
                    남들이 모르는 아픔과 외로움으로 혼자 힘들어 하고 있지는 않나요? 하나님은 언제나 나와 함께하기를 원하시고 나를 축복하시는 분임을 기억하세요.
                </div>
                <div className={"text-red-400"}>'너의 하나님 여호와가 너의 가운데에 계시니 그는 구원을 베푸실 전능자 이시라 그가 너로 말미암아 기쁨을 이기지 못하시며 너를 잠잠히 사랑하시며 너로 말미암아 즐거이 부르며 기뻐하시리라 하리라' (스바냐 3:17)</div>
            </div>
            <button
