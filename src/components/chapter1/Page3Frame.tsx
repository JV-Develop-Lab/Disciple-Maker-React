    ...
    return (
        <div className={`${(nowPage === 2) ? "" : "hidden"} overflow-scroll-y`}>
            ...
            <div className={"mb-4"}>
                ...
                <div>
                    사람은 하나님과 함께 행복하게 살도록 창조되었습니다. 그러나 죄를 지은 인산이 거룩하신 하나님과 함께 하지 못하게 되었고 하나님의 축복과 행복한 삶에서 멀어지게 되었습니다.
                </div>
                <div>
                    성경은 죄의 결과는 죽임이라고 이야기합니다. 죽음 이후에는 반드시 심판이 있는데 이로 인해 두려움과 질병, 부끄러움, 우울증 등 여러 고통과 불행이 시작되었습니다.
                </div>
                <div>
