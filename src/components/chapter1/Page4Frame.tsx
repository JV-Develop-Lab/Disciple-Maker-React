        ...
        <div className={`${(nowPage === 3) ? "" : "hidden"} overflow-scroll-y`}>
            ...
            <div className={"mb-4"}>
                <div className={"bg-red-200 p-2 mb-2"}>
                    <div>[이사야 53: 3~6]</div>
                    <div>
                        3 그는 멸시를 받아 사람들 에게 버림 받았으며 간고를 많이 겪었으며 질고를 아는 자라 마치 사람들이 그에게서 얼굴을 가리는 것 같이 멸시를 당하였고 우리도 그를 귀히 여기지 아니 하였도다
                    </div>
                    <div>4 그는 실로 우리의 질고를 지고 우리의 슬픔을 당하였 거늘 우리는 생각하기를 그는 징벌을 받아 하나님께 맞으며 고난을 당한다 하였노라</div>
            ...
            <div className={"mb-4"}>
                ...
                <div className={`mb-2`}>
                    당신은 이제 예수 그리스도를 알게 되었습니다.
                    그러나 예수 그리스도를 아는 것만으로는 부족합니다.
                    예수 그리스도를 믿지 않고서는 하나님의 평안과 기쁨, 행복을 맛 볼 수 없습니다. 죄의 문제를 해결하실 수 있는 분은 오직 예수 그리스도 한 분이십니다. 예수님을 내 마음에 모셔 드리고 나의 주님, 나의 하나님으로 모셔드릴 때 하나님과의 관계가 회복되고 하나님이 약속하신 축복을 누릴 수 있습니다.
                </div>
            </div>
            <div className="mb-4">
                <div className={"bg-red-200 p-2 mb-2"}>
                    ...
                    <div>
                        사랑의 주 예수님, 저는 죄인입니다.
                        지금까지 나의 인생은 내가 주인이 되어 살아왔음을 고백합니다. 하나님의 아들 예수 그리스도께서 나의 죄를 용서하시기 위해 십자가에서 피 흘려 죽으시고 부활하셨음을 믿습니다. 이제 나는 내 마음의 문을 열고 예수님을 나의 생명의 구세주로, 나의 주인, 나의 하나님으로 모셔 드립니다. 사랑의 주 예수님, 지금이 시간내 마음에 들어와s주십시오.
