...
function Page5Frame() {
  ...
  return (
    <div
      className={`${
        nowPage === 4 ? "" : "hidden"
      } overflow-scroll-y flex flex-col justify-start items-center`}
    >
      <div className={"mb-40"}>
        <div className={"text-xl font-bold mb-2"}>함께 나누어 보세요!</div>
        <div className={"mb-2 font-semibold"}>
          <div>
            1. 오늘 제자양육을 통해 새롭게 깨달은 것들을 기록하고 나누어 보세요
          </div>
          <div className={"flex"}>
            <input
      ...
      <div className={"text-3xl font-bold text-orange-500 mb-20"}>
        Let there be light!!!
      </div>
      <button
        className={
